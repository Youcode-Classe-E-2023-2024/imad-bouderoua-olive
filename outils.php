...
<body>
  ...
  <div class="textholder"><h2>La Taille de l’olivier</h2><div class="entry-content single-content">
  <h1>La Taille de l’olivier </h1>  
            Les anciens aimaient les grands arbres car ils pensaient que plus l'arbre 
                était important, plus grande serait la quantité de fruits menée au moulin.
                Ils laissaient donc l'olivier grandir dans toutes les directions. Ils avaient 
                quand même remarqués que la fructification se faisait principalement sur
                les parties retombantes des rameaux (penduliers).
            La taille de l'olivier est une opération importante, voire essentielle dans la
                la culture de l'olivier. La taille a pour but de former, de favoriser la 
                fructification ou de permettre la reprise d'un olivier laissé à l'abandon.
            ...
            <div class="titre1">L’Olivier de Production 
            Comme tous les arbres fruitiers, l'olivier est régulièrement taillé. Il peut
                être taillé toute l'année, mais les mois de mars, avril et mai sont les mois
                de la taille, entre les risques de gel et la floraison.
                tailles favorisant la production de fruits et la taille purement esthétique.
                Les tailles concernant la production comprennent la taille de formation, la
                taille de fructification et la taille de reprise.
                La taille de formation sur le jeune arbre, a pour but de former un 
                monotronc en éliminant les branches afin de renforcer la ligne centrale. 
                Quand le jeune olivier atteint 1.50m, il convient de lui donner une forme
                équilibrée et rationnelle pour son exploitation.
                La taille de fructification est pour sa part limitée à l'entretien et à 
                l'harmonisation. Elle est annuelle et ne doit pas être trop sévère sinon elle
                irait à l'encontre de la régulation de la production de l'olivier mais les 
                tailles successives améliorent les récoltes.
